...
- (BOOL)application:(UIApplication *)application didFinishLaunchingWithOptions:(NSDictionary *)launchOptions
{
    ...
    MenuTVC *leftVC = [[[MenuTVC alloc] init] autorelease];
    
    NSSidebarController *rootVC = [[[NSSidebarController alloc] initWithMainController:mainVC] autorelease];
    rootVC.leftController = leftVC;
    rootVC.rightController = leftVC;
